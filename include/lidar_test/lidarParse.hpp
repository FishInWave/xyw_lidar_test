...
namespace xyw_lidar_test
{
    ...
    public:
        ...
        void testMap()
        {
            ...
            unordered_map<string, int> um_temp;
            um.emplace(pair<string, int>("a", 1));
            um.emplace(pair<string, int>("b", 1));
            um.emplace(pair<string, int>("c", 1));
            um_temp.emplace(pair<string, int>("d", 1));
            um_temp.emplace(pair<string, int>("e", 1));
            swap(um, um_temp);
            cout << "um: " << endl;
            for (auto i : um)
            {
